      ...
      schemas: {
        ...
        PlatformOrganisationRequest: {
          ...
          properties: {
            ...
            representativeEmail: { type: 'string', format: 'email', example: 'adriano@example.com' },
            representativePhone: nullableString('+1234567890'),
            status: enumString(['PENDING_REVIEW', 'CONTACTED', 'APPROVED', 'REJECTED', 'CANCELLED'], 'PENDING_REVIEW'),
        ...
        RejectOrganisationRequest: {
          ...
          additionalProperties: false,
          properties: {
            rejectionReason: { type: 'string', maxLength: 1000, example: 'The domain representative is invalid.' },
          },
        },
        PlatformOrganisationDetail: {
          type: 'object',
          required: ['id', 'name', 'status', 'createdAt', 'updatedAt', '_count', 'registrationRequest', 'setupStatus', 'resendEligibility', 'admins', 'timeline'],
          properties: {
            id: uuidString('f6fdeb4d-3b7d-4bad-9bdd-2b0d7b3dcb6d'),
            name: { type: 'string', example: 'Example Consulting' },
            status: enumString(['PENDING_ONBOARDING', 'ACTIVE', 'INACTIVE', 'SUSPENDED', 'DISABLED', 'ARCHIVED'], 'PENDING_ONBOARDING'),
            createdAt: dateTimeString('2026-05-16T09:00:00.000Z'),
            updatedAt: dateTimeString('2026-05-16T09:00:00.000Z'),
            _count: {
              type: 'object',
            ...
            registrationRequest: {
              type: 'object',
              nullable: true,
              required: ['id', 'representativeFirstName', 'representativeLastName', 'representativeEmail'],
              properties: {
                id: uuidString('9b1deb4d-3b7d-4bad-9bdd-2b0d7b3dcb6d'),
                representativeFirstName: { type: 'string', example: 'Adriano' },
                representativeLastName: { type: 'string', example: 'Jorge' },
            ...
            setupStatus: {
              ...
              properties: {
                ...
                status: enumString(['PENDING', 'SENT', 'FAILED_TO_SEND', 'ACCEPTED', 'COMPLETED', 'EXPIRED', 'REVOKED', 'REJECTED'], 'PENDING'),
