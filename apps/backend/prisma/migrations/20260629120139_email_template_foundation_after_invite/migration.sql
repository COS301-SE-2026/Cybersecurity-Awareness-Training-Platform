/*
  ...
  - The values [ORGANISATION_REQUEST_APPROVED] on the enum `EmailDeliveryType` will be removed. If these variants are still used in the database, this will fail.
