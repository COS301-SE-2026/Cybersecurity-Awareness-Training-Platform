...
-- CreateEnum
CREATE TYPE "AuditTargetType" AS ENUM ('USER', 'ORGANISATION', 'ORGANISATION_REGISTRATION_REQUEST', 'INVITATION', 'ORGANISATION_ADMIN_PERMISSION', 'ORGANISATION_SECURITY_SETTINGS', 'PLATFORM_ADMIN_ROLE', 'AUTH_SESSION', 'CAMPAIGN', 'OTHER');
