function BrandHeroSection() {
  return (
    <section className="pb-2 bg-light-purple">
      <div className="pt-16 px-4 mx-auto max-w-screen-xl text-left">
        ...
        <h1 className="font-jost text-6xl font-medium tracking-wide text-dark-pink">
          Insightful Phish
        </h1>
        <h1 className="font-jost mb-1 text-8xl font-semibold tracking-regular text-purple">
          BRAND GUIDELINES
        </h1>

        <p className="mb-8 text-2xl font-overpass tracking-wide text-dark-pink font-medium">
          A comprehensive guide to the brand's visual identity and design system.
        </p>
