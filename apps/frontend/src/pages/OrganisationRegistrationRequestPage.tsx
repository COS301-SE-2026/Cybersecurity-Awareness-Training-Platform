...
function OrganisationRegistrationRequestPage() {
  ...
  return (
    <section
      className="min-h-screen bg-light-purple"
      aria-label="Organisation registration request"
    >
      <div className="mx-auto flex min-h-screen flex-col items-center justify-center px-4 py-8 sm:px-6 lg:py-10">
        <div className="mb-4 flex flex-wrap items-center justify-center gap-2 sm:gap-3">
          <img src="/Phish Logo Light.png" className="h-12 sm:h-14" alt="Insightful Phish Logo" />
          <span className="flex items-center gap-2 mt-2">
            <span className="font-overpass self-center text-[1.45rem] text-pink text-heading font-medium whitespace-nowrap tracking-wide sm:text-[1.94rem]">
              Insightful
            </span>
            <span className="font-overpass self-center text-[1.45rem] text-pink text-heading font-black whitespace-nowrap tracking-wide sm:text-[1.94rem]">
              Phish.
            </span>
          </span>
        </div>

        <div className="w-full max-w-4xl bg-white-purple p-4 shadow sm:p-6 lg:p-8">
          {/* HEADING */}
          <h3 className="font-jost text-2xl text-purple tracking-wider font-medium text-heading sm:text-3xl">
            Request to Register an Organisation
          </h3>

          {/* SUB-HEADING */}
          <p className="font-regular tracking-wide text-[1rem] font-justify font-jost mt-1 text-dark-pink mb-4 sm:text-[1.1rem]">
          ...
          <ul className="hidden text-sm font-medium text-center text-body sm:flex -space-x-px">
            <li className="w-full focus-within:z-10">
              <button
                ...
                className={`font-jost inline-block w-full bg-neutral-primary-soft border border-default hover:bg-neutral-secondary-medium hover:text-[var(--ip-purple)] focus:ring-4 focus:ring-neutral-secondary-strong font-light text-[1rem] tracking-wide leading-5 px-4 py-3 focus:outline-none lg:text-[1.2rem] lg:px-5 ${
                  currentStep === 1
          ...
          <div className="w-full bg-neutral-primary-soft p-4 border-default border sm:p-6 lg:p-8">
            {currentStep === 1 && (
