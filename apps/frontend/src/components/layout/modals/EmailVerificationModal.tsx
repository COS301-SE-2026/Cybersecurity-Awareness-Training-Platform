        ...
        <div className="relative bg-white-purple border border-default shadow-md p-4 md:p-6">
          ...
          <div className="pt-4 md:pt-6">
            ...
            <button
              ...
              className="mb-4 cursor-pointer w-full inline-flex items-center justify-center text-white font-jost text-[1.2rem] font-regular tracking-wider bg-main-purple hover:bg-hover-purple box-border border border-transparent focus:ring-4 focus:ring-brand-medium shadow-xs leading-5 text-sm px-4 py-2.5 focus:outline-none disabled:opacity-60 disabled:cursor-not-allowed"
            >
