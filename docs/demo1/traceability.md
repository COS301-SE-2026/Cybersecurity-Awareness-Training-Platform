...
| UC-02: View Training Document         | UC-02 user story in `SRS.md`     | UC-02 core use case         | FR-UC02-01 to FR-UC02-10; TRK-UC02-01 to TRK-UC02-04                         | API-UC02-01 to API-UC02-03; API-TRK-02               | `User`, `TraineeProfile`, `CampaignAssignment`, `CampaignItem`, `TrainingDocument`, `InteractionEvent`                              | `DESIGN.md` Training Module List and Training Material Page            | QA-UC02-01 to QA-UC02-05              | Frontend training list/document screens; backend training interaction APIs                                     | Connor  | Integrated draft   |
| UC-03: Complete Quiz Flow             | UC-03 user story in `SRS.md`     | UC-03 core use case         | FR-UC03-01 to FR-UC03-10; TRK-UC03-01 to TRK-UC03-06                         | API-UC03-01 to API-UC03-04; API-TRK-03 to API-TRK-05 | `User`, `TraineeProfile`, `CampaignItem`, `Quiz`, `QuizQuestion`, `AnswerOption`, `QuizAttempt`, `AttemptAnswer`, `QuizResult`      | `DESIGN.md` Quiz Page, Submission State, and Results Page              | QA-UC03-01 to QA-UC03-05              | Frontend quiz/results screens; backend quiz attempt/submission/result APIs                                     | Zoë     | Integrated draft   |
