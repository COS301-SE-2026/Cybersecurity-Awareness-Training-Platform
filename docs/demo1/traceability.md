...
| --------------- | ---------------------------------- | ------------------- | ------------------------------------------------- | ------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | ------ |
| TRACE-TRK-01    | Simulated email opened/viewed      | UC-01               | TRK-UC01-01, TRK-UC01-02, TRK-UC01-03, FR-UC01-04 | API-TRK-01 / `POST /trainee/simulated-emails/:emailId/opened`                        | `InteractionEvent`, `SimulatedEmail`, `TraineeProfile`                           | Records lightweight simulated inbox interaction events.                                | Draft  |
...
| Simulated email          | Simulated email                 | `GET /trainee/simulated-emails/:emailId`                                | `SimulatedEmail`                                         | Aligned | Does not represent real mailbox email delivery.                                                           |
| Simulated email tracking | Email opened/viewed interaction | `POST /trainee/simulated-emails/:emailId/opened`                        | `InteractionEvent`                                       | Aligned | Used for lightweight UC-01 interaction tracking.                                                          |
| Email classification     | Email classification response   | `POST /trainee/simulated-emails/:emailId/classification`                | `EmailClassificationResponse`, `EmailRedFlag`            | Aligned | Records classification separately from quiz attempts.                                                     |
