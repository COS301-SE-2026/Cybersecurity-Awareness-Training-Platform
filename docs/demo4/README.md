# Insightful Phish Demo 4 Documentation

This directory contains the final Demo 4 documentation for Insightful Phish. The documentation describes behaviour present in the current product rather than planned or historical scope.
